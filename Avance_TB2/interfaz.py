...
def ventana_A():
    ...
    titulo1 = Label(ventana_A, text="Algoritmo A....en proceso", font=("Arial", 12))
    titulo1.grid(row=3, column=0, sticky='w')
...
def ventana_B():
    ...
    titulo2 = Label(ventana_B, text="Algoritmo B....en proceso", font=("Arial", 12))
    titulo2.grid(row=3, column=1, sticky='w')
...
def ventana_grafo():
    ...
    imagen = PhotoImage(file = "pictures/grafos/grafo_temp.png")
